...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        {{ isset($dontTranslateMainTitle) ? $mainTitle : trans("lang.".$mainTitle) }}
        <small> {{ isset($dontTranslateTitle) ? $title : trans("lang.".$title) }}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> {{ isset($dontTranslateMainTitle) ? $mainTitle : trans("lang.".$mainTitle) }} </a></li>
        <li class="active">{{ isset($dontTranslateTitle) ? $title : trans("lang.".$title) }}</li>
      </ol>
    </section>
