        ...
        <li class="treeview {{ Request::segment(1) == 'courses' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ Request::url() == route('all-courses') ? 'active' : '' }}">
            	<a href="{{ route('all-courses') }}"><i class="fa fa-circle-o"></i>{{ trans('lang.allCourses') }}</a>
            </li>
            <li class="{{ Request::url() == route('create-course') ? 'active' : '' }}">
            	<a href="{{ route('create-course') }}"><i class="fa fa-circle-o"></i>{{ trans('lang.addNewCourse') }}</a>
            </li>
          </ul>
        </li>
